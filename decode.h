...
int agg_p_decode1(Oid aggfn, char *p1, xrg_attr_t *attr1, Oid atttypid, int atttypmod, Datum *pg_datum, bool *og_isnull);
int agg_p_decode2(Oid aggfn, char *p1, xrg_attr_t *attr1, char *p2, xrg_attr_t *attr2, Oid atttypid, int atttypmod, Datum *pg_datum, bool *og_isnull);
#endif
